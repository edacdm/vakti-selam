      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
          ...
          >
            ...
            <Text style={styles.heroTitle}>{t("namazTeheccud")}</Text>
            
            <View style={styles.badgeContainer}>
              <View style={[styles.badge, styles.badgeHighlight]}>
                <Text style={styles.badgeTextHighlight}>2 - 8 {t("rekatLabel")}</Text>
              </View>
            </View>
          </LinearGradient>
          ...
          >
            ...
            <Text style={styles.sectionSubtitle}>{t("namazTeheccud")}</Text>
            ...
            <View style={styles.pathwayContainer}>
              {renderStep(
                "1",
                t("prayTeheccudStep1Title"),
                t("prayTeheccudStep1Content")
              )}
              {renderStep(
                "2",
                t("prayTeheccudStep2Title"),
                t("prayTeheccudStep2Content"),
                true
              )}
            </View>
            ...
            <View style={styles.infoRow}>
              ...
              <Text style={styles.infoRowText}>{t("prayTeheccudInfo")}</Text>
            </View>
          </LinearGradient>
