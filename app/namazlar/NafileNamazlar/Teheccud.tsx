...
export default function Teheccud() {
    ...
    <LinearGradient colors={["#080C16", "#121E36"]} style={styles.container}>
      <SafeAreaView style={styles.safeArea}>
        ...
        <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
          ...
          >
            <MaterialCommunityIcons name="weather-night" size={56} color="#D4AF37" />
            <Text style={styles.heroTitle}>Teheccüd Namazı</Text>
            
            <View style={styles.badgeContainer}>
              <View style={[styles.badge, styles.badgeHighlight]}>
                <Text style={styles.badgeTextHighlight}>2 - 8 Rekat</Text>
              </View>
            </View>
          </LinearGradient>
          ...
          >
            <View style={styles.sectionHeader}>
              ...
              <Text style={styles.sectionTitle}>Teheccüd (Nafile) Kılınışı</Text>
            </View>

            <View style={styles.niyetBox}>
              <MaterialCommunityIcons name="hands-pray" size={24} color="#D4AF37" />
              <Text style={styles.niyetText}>
                “Niyet ettim Allah rızası için teheccüd namazını kılmaya.”
              </Text>
            </View>
            ...
            <View style={styles.pathwayContainer}>
              {renderStep(
                "1",
                "İkişer Rekatlık Kılınış",
                "Tıpkı sabah namazının sünneti gibi kılınır. Her iki rekatta bir selam verilmesi tavsiye edilir. İki rekatta selam verilecekse birinci rekatta Subhaneke, Fatiha ve zamm-ı sure, ikinci rekatta Fatiha ve zamm-ı sure okunur."
              )}
              {renderStep(
                "2",
                "Dört Rekatlık Kılınış",
                "Dört rekatta bir selam verilecekse ikindi namazının sünneti gibi kılınır. Yani ilk oturuşta salli-barik duaları okunur, üçüncü rekatın başında sübhaneke tekrar okunur.",
                true
              )}
            </View>
            ...
            <View style={styles.infoRow}>
              ...
              <Text style={styles.infoRowText}>Yatsı namazından sonra ve sabah vakti girmeden, uykudan kalkarak kılınması en eftalidir.</Text>
            </View>
          </LinearGradient>
...
const styles = StyleSheet.create({
  ...
  heroTitle: { fontSize: 28, fontWeight: "300", color: "#E2E8F0", letterSpacing: 2, marginTop: 15, marginBottom: 20, textAlign: "center" },
