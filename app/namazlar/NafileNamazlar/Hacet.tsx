      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
          ...
          >
            ...
            <Text style={styles.heroTitle}>{t("namazHacet")}</Text>
            
            <View style={styles.badgeContainer}>
              <View style={[styles.badge, styles.badgeHighlight]}>
                <Text style={styles.badgeTextHighlight}>2 veya 4 {t("rekatLabel")}</Text>
              </View>
            </View>
          </LinearGradient>
          ...
          >
            ...
            <Text style={styles.sectionSubtitle}>{t("namazHacet")}</Text>
            ...
            <View style={styles.pathwayContainer}>
              {renderStep(
                "1",
                t("namazStep1Title"),
                t("prayHacetStep1Content")
              )}
              {renderStep(
                "2",
                t("namazStep2Title"),
                t("prayHacetStep2Content"),
                true
              )}
            </View>
            ...
            <View style={styles.infoRow}>
              ...
              <Text style={styles.infoRowText}>{t("prayHacetInfo")}</Text>
            </View>
          </LinearGradient>
