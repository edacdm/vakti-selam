    ...
    <LinearGradient colors={["#080C16", "#121E36"]} style={styles.container}>
      <SafeAreaView style={styles.safeArea}>
        ...
        <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
          ...
          >
            <MaterialCommunityIcons name="heart-outline" size={56} color="#D4AF37" />
            <Text style={styles.heroTitle}>Şükür Namazı</Text>
            
            <View style={styles.badgeContainer}>
              <View style={[styles.badge, styles.badgeHighlight]}>
                <Text style={styles.badgeTextHighlight}>2 Rekat</Text>
              </View>
            </View>
          </LinearGradient>
          ...
          >
            <View style={styles.sectionHeader}>
              ...
              <Text style={styles.sectionTitle}>Şükür Namazı Kılınışı</Text>
            </View>
            ...
            <View style={styles.pathwayContainer}>
              {renderStep(
                "1",
                "Birinci Rekat",
                "Tekbir alınır, Sübhaneke okunur. Fatiha ve zamm-ı sure (herhangi biri olabilir) okunur. Rükû ve secdeler yapılarak ikinci rekata kalkılır."
              )}
              {renderStep(
                "2",
                "İkinci Rekat ve Selam",
                "Fatiha ve zamm-ı sure okunur. Rükû, secde ve oturuş tamamlanarak sağa ve sola selam verilerek bitirilir.",
                true
              )}
            </View>
            ...
            <View style={styles.infoRow}>
              ...
              <Text style={styles.infoRowText}>Bir musibetten kurtulunca yahut güzel bir nimete nail olunca Allah'a hamdetmek ve şükretmek niyetiyle kılınır.</Text>
            </View>
          </LinearGradient>
