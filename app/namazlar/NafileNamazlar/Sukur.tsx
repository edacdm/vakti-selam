      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
          ...
          >
            ...
            <Text style={styles.heroTitle}>{t("namazSukur")}</Text>
          ...
          >
            ...
            <Text style={styles.sectionSubtitle}>{t("namazSukur")}</Text>
            ...
            <View style={styles.infoRow}>
              ...
              <Text style={styles.infoRowText}>{t("praySukurInfo")}</Text>
            </View>
          </LinearGradient>
