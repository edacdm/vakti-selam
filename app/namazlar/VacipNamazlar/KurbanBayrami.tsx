...
export default function KurbanBayrami() {
    ...
    <LinearGradient colors={["#080C16", "#121E36"]} style={styles.container}>
      <SafeAreaView style={styles.safeArea}>
        ...
        <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
          ...
          >
            <MaterialCommunityIcons name="sheep" size={56} color="#D4AF37" />
            <Text style={styles.heroTitle}>Kurban Bayramı Namazı</Text>
          ...
          >
            ...
            <View style={styles.niyetBox}>
              ...
              <Text style={styles.niyetText}>
                “Niyet ettim Allah rızası için bugünkü Kurban Bayramı namazını kılmaya, uydum hazır olan imama.”
              </Text>
            </View>
            ...
            <View style={styles.pathwayContainer}>
              {renderStep(
                "1",
                "Birinci Rekat",
                "İftitah tekbiri ile başlanır, 'Sübhaneke' okunur. Peş peşe 3 zavait tekbiri getirilir. Ardından Fâtiha ve sure okunarak rükû ve secdeye gidilir."
              )}
              {renderStep(
                "2",
                "İkinci Rekat ve Selam",
                "Doğrudan imama uymaya devam edilir, imam açıktan dua okur. Sonra rükûya gitmeden hemen önce peş peşe 3 kez tekbir alınır. 4. tekbirle rükûya gidilir, secdelerin ve oturuşta duaların ardından selam verilir.",
                true
              )}
            </View>
            ...
            <View style={styles.infoRow}>
              ...
              <Text style={styles.infoRowText}>Ramazan bayramıyla kılınışı tıpatıp aynıdır. Arife günü sabahtan itibaren farz namazlar ardında okunan teşrik tekbiri unutulmamalıdır.</Text>
            </View>
          </LinearGradient>
...
const styles = StyleSheet.create({
  ...
  heroTitle: { fontSize: 26, fontWeight: "300", color: "#E2E8F0", letterSpacing: 2, marginTop: 15, marginBottom: 20, textAlign: "center" },
