...
export default function VitirNamazi() {
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
          ...
          >
            ...
            <Text style={styles.heroTitle}>Vitir Namazı</Text>
            
            <View style={styles.badgeContainer}>
              <View style={[styles.badge, styles.badgeHighlight]}>
                <Text style={styles.badgeTextHighlight}>Toplam 3 Rekat</Text>
              </View>
            </View>
          </LinearGradient>
          ...
          >
            <View style={styles.sectionHeader}>
              ...
              <Text style={styles.sectionTitle}>Vitir (Vacip) Kılınışı</Text>
            </View>
            ...
            <View style={styles.pathwayContainer}>
              ...
              {renderStep(
                ...
                "Sadece Fâtiha ve bir sure okunur, rükû ve secde yapıldıktan sonra oturulur. Yalnızca Ettehiyyatü duası okunur ve 3. rekata kalkılır."
              )}
              {renderStep(
                "3",
                "Üçüncü Rekat ve Kunut",
                "Fâtiha ve sure okunur. Ardından eller kulaklara kaldırılarak tekbir alınır. Kunut duaları okunur. Rükû secde yapıldıktan sonra son oturuşa geçilir. Tahiyyat, Salli-Barik, Rabbena okunur ve selam verilir.",
                true
              )}
            </View>
            ...
            <View style={styles.infoRow}>
              ...
              <Text style={styles.infoRowText}>Vitir namazı yatsı namazından hemen sonra kılınmak zorunda değildir, yatsı vakti girmeden ise kılınmaz.</Text>
            </View>
          </LinearGradient>
