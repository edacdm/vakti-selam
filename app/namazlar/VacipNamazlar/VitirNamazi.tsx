      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
          ...
          >
            ...
            <Text style={styles.heroTitle}>{t("namazVitir")}</Text>
            
            <View style={styles.badgeContainer}>
              <View style={[styles.badge, styles.badgeHighlight]}>
                <Text style={styles.badgeTextHighlight}>3 {t("rekatLabel")}</Text>
              </View>
            </View>
          </LinearGradient>
          ...
          >
            ...
            <View style={styles.pathwayContainer}>
              ...
              {renderStep(
                ...
                t("prayYatsiWitrStep1Content")
              )}
              {renderStep(
                "3",
                t("prayYatsiWitrStep3Title"),
                t("prayYatsiWitrStep3Content"),
                true
              )}
            </View>
            ...
            <View style={styles.infoRow}>
              ...
              <Text style={styles.infoRowText}>{t("prayWitrInfo")}</Text>
            </View>
          </LinearGradient>
